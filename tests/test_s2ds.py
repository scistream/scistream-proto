...
def test_start_multiple_subprocesses(stunnel_subprocess):
    ...
    stunnel_subprocess.update_listeners(result1["listeners"], result1["s2ds_proc"], "test-uid", "CONS")
    stunnel_subprocess.update_listeners(result2["listeners"], result2["s2ds_proc"], "test-uid2", "CONS")
